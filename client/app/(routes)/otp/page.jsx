  ...
  return (
    <div className="flex items-center justify-center  px-4 pt-10 pb-20  mx-auto ">
      <div className="max-w-md w-full bg-white shadow-md rounded-lg p-8">
        ...
        <h2 className="text-2xl font-bold text-center text-[#c80f2e] mb-4">
          Enter OTP 
        </h2>
        ...
        <div className="mt-4 text-center">
          ...
          <button onClick={handleResendOtp} className="hover:underline mt-2 text-[#c80f2e] hover:text[#c80f2e]">Resend OTP</button>
        </div>
      </div>
    </div>
  );
